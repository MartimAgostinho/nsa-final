...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{>{\centering\arraybackslash}X >{\centering\arraybackslash}X >{\centering\arraybackslash}X}
        ...
        \midrule
        $M_{3}$ & \SI{-50}{\milli\volt} & \textcolor{red}{\SI{-50}{\micro\ampere}}\\
        \midrule
        $M_{4}$ & \SI{-50}{\milli\volt} & \textcolor{red}{\SI{-50}{\micro\ampere}}\\
        \midrule
        $M_{5}$ & \SI{100}{\milli\volt} & \textcolor{red}{\SI{50}{\micro\ampere}}\\
        \midrule
        $M_{6}$ & \SI{100}{\milli\volt} & \textcolor{red}{\SI{50}{\micro\ampere}}\\
        \midrule
        $M_{7a}$ & \SI{60}{\milli\volt} & \textcolor{red}{\SI{75}{\micro\ampere}}\\
        \midrule
        $M_{7b}$ & \SI{60}{\milli\volt} & \SI{25}{\micro\ampere}\\
        \midrule
        $M_{8a}$ & \SI{60}{\milli\volt} & \textcolor{red}{\SI{75}{\micro\ampere}}\\
        \midrule
        $M_{8b}$ & \SI{60}{\milli\volt} & \SI{25}{\micro\ampere}\\
        \midrule
        $M_{9}$ & \SI{100}{\milli\volt} & \SI{-100}{\micro\ampere}\\
        \midrule
        $M_{10}$ & \SI{-50}{\milli\volt} & \textcolor{red}{\SI{-25}{\micro\ampere}}\\
        \midrule
        $M_{11}$ & \SI{-50}{\milli\volt} & \textcolor{red}{\SI{-25}{\micro\ampere}}\\
        \midrule
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{>{\centering\arraybackslash}X >{\centering\arraybackslash}X >{\centering\arraybackslash}X}
        ...
        $M_{9}$ & \SI{100}{\milli\volt} & \SI{-100}{\micro\ampere}\\
        \midrule
        $M_{10}$ & \SI{-50}{\milli\volt} & \textcolor{red}{\SI{-50}{\micro\ampere}}\\
        \midrule
        $M_{11}$ & \SI{-50}{\milli\volt} & \textcolor{red}{\SI{-50}{\micro\ampere}}\\
        \midrule
        $M_{12}$ & \SI{100}{\milli\volt} & \SI{25}{\micro\ampere}\\
        \midrule
        $M_{13}$ & \SI{100}{\milli\volt} & \SI{25}{\micro\ampere}\\
