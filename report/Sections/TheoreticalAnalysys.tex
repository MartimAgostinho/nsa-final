...
The gain bandwidth product can be obtained by the ratio between $G_M$ and $C{out}$ that is the dominant pole and is the equivalent capacitance seen from the output node.
